...
const artifactPatterns = {
  ...
  product: ['frontends/dsh/dist/**/*', 'frontends/notes/dist/**/*', 'frontends/office/dist/**/*', 'frontends/office/runtime/.clawmaster-office-manifest.json', 'native/system/packages/*/bin/**/*', 'apps/desktop-tauri/dist/**/*', ...generatedIcons],
}
...
if (process.argv[1] && realpathSync(resolve(process.argv[1])) === fileURLToPath(import.meta.url)) {
  ...
  if (desktopBuildMode() === 'release') assertReleaseCommit(source, process.env.DSH_DESKTOP_RELEASE_COMMIT)
