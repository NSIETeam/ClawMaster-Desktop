...
export const zh = {
  ...
  'message.producer.clawmasterInstructions': 'ClawMaster 工作指令',
  'message.producer.currentTime': '当前时间',
  ...
  'message.turnProcess.working': '工作中',
  'message.turnProcess.workingTool': '正在调用工具',
  'message.turnProcess.workingToolNamed': '正在调用 {name}',
  'message.turnProcess.workingContext': '正在注入上下文',
  'message.turnProcess.workingReasoning': '正在思考',
  'message.turnProcess.workingMessage': '正在回复',
  'message.stopped': '已停止',
...
export const en = {
  ...
  'message.producer.clawmasterInstructions': 'ClawMaster instructions',
  'message.producer.currentTime': 'Current time',
  ...
  'message.turnProcess.workingTool': 'Calling a tool',
  'message.turnProcess.workingToolNamed': 'Calling {name}',
  'message.turnProcess.workingContext': 'Injecting context',
  'message.turnProcess.workingReasoning': 'Thinking',
  'message.turnProcess.workingMessage': 'Replying',
